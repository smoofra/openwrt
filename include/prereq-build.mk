...
$(eval $(call TestHostCommand,zlib, \
	...
	echo 'int main(int argc, char **argv) { gzdopen(0, "rb"); return 0; }' | \
		$(HOSTCC) $(HOST_CFLAGS) $(HOST_LDFLAGS) -include zlib.h -x c -o $(TMP_DIR)/a.out - $(zlib_link_flags)))

$(eval $(call TestHostCommand,libssl, \
	Please install the openssl library (with development headers), \
	echo 'int main(int argc, char **argv) { SSL_library_init(); return 0; }' | \
		$(HOSTCC) $(HOST_CFLAGS) -include openssl/ssl.h -x c -o $(TMP_DIR)/a.out - -lcrypto -lssl $(HOST_LDFLAGS)))
